...
export default function TechStack() {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center gap-8 my-4">
      <div className="flex font-sacramento text-3xl md:text-6xl">
        Tech Stack
      </div>
      <div className="grid grid: sm:grid-cols-2 md:grid-cols-4 gap-4 ">
        {stacks.map((stack) => (
          <div
            key={stack.id}
            className="flex flex-col gap-2 bg-black/30 p-4 rounded-sm"
          >
            <h3 className="text-sm md:text-md font-moms-typewriter text-mauve-100">
              {stack.title}
            </h3>
